...
p1 %>%
  filter(!is.na(Slug)) %>%
  ggplot(aes(x = Slug,y = Percentage, fill = factor(Slug) )) +
  geom_bar(stat='identity',colour="white")  +
  scale_fill_manual(values = c(fillColor2,fillColor,fillColor,fillColor,fillColor,fillColor,fillColor,fillColor,fillColor,fillColor)) + 
